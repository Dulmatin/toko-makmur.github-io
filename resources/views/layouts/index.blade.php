...
<html lang="en">
  ...
  <section id="home-section" class="hero">
		  ...
		  <div class="slider-item" style="background-image: url('{{ url('frontend/images/bg_1.jpg')}}')">
		  ...
		  <div class="slider-item" style="background-image: url('{{ url('frontend/images/bg_2.jpg')}}')">
